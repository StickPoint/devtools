 ...
 * @since 2022/03/05
 */
public enum SmallApplicationCodeEnums {
    /**
     * 请求正常
     */
     ...
     * @param message 信息
     */
    SmallApplicationCodeEnums(int code, String message) {
        this.code = code;
    ...
    public static String getMessageByCode(int code) {
        for (SmallApplicationCodeEnums codeEnum : SmallApplicationCodeEnums.values()) {
