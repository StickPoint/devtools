...
public class DevToolsException extends RuntimeException{
     ...
     * @param msg 异常信息
     */
    public DevToolsException(int code, String msg) {
        super(msg);
        this.code = code;
    }
     ...
     * @param cause 异常原有
     */
    public DevToolsException(int code, String msg, Throwable cause) {
        super(msg, cause);
        this.code = code;
    }
     ...
     */
    public DevToolsException(DevToolsCodeEnums aliyunDriveCodeEnums) {
     ...
     * @param e 传入一个异常对象
     */
    public DevToolsException(Exception e) {
        super(e);
        this.code = DevToolsCodeEnums.FAILED.getCode();
    }
     ...
     */
    public DevToolsException(DevToolsCodeEnums aliyunDriveCodeEnums, String... msg) {
