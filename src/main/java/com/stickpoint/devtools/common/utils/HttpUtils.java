...
public class HttpUtils {
    ...
    public String doMsAddressGet(String requestUrl){
    ...
    public String doMsWeatherInfoGet(String requestUrl){
        ...
        throw new DevToolsException(DevToolsCodeEnums.FAILED);
    }
    ...
    public String doGet(String url,Map<String,String> headerMap) throws IOException {
        ...
        try(BufferedReader in = new BufferedReader(new InputStreamReader(conn.getInputStream(), StandardCharsets.UTF_8))) {
            if (conn.getResponseCode() == AppEnums.APP_NETWORK_STATUS_OK.getNumberInfo()) {
                String line;
